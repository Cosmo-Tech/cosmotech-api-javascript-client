...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CosmotechApi.SimulationSearch();
  });
  ...
  describe('SimulationSearch', function() {
    it('should create an instance of SimulationSearch', function() {
      // uncomment below and update the code to test SimulationSearch
      //var instane = new CosmotechApi.SimulationSearch();
