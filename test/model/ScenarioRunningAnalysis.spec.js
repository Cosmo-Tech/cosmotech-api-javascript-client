...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CosmotechApi.ScenarioRunningAnalysis();
  });
  ...
  describe('ScenarioRunningAnalysis', function() {
    it('should create an instance of ScenarioRunningAnalysis', function() {
      // uncomment below and update the code to test ScenarioRunningAnalysis
      //var instane = new CosmotechApi.ScenarioRunningAnalysis();
      //expect(instance).to.be.a(CosmotechApi.ScenarioRunningAnalysis);
    });
    ...
    it('should have the property analysisId (base name: "analysisId")', function() {
      ...
      //var instance = new CosmotechApi.ScenarioRunningAnalysis();
