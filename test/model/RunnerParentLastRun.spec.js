...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CosmotechApi.RunnerParentLastRun();
  });
  ...
  describe('RunnerParentLastRun', function() {
    it('should create an instance of RunnerParentLastRun', function() {
      // uncomment below and update the code to test RunnerParentLastRun
      //var instance = new CosmotechApi.RunnerParentLastRun();
      //expect(instance).to.be.a(CosmotechApi.RunnerParentLastRun);
    });

    it('should have the property runnerRunId (base name: "runnerRunId")', function() {
      // uncomment below and update the code to test the property runnerRunId
      //var instance = new CosmotechApi.RunnerParentLastRun();
