...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CosmotechApi.ScenarioRunStartSolution();
  });
  ...
  describe('ScenarioRunStartSolution', function() {
    it('should create an instance of ScenarioRunStartSolution', function() {
      // uncomment below and update the code to test ScenarioRunStartSolution
      //var instane = new CosmotechApi.ScenarioRunStartSolution();
      //expect(instance).to.be.a(CosmotechApi.ScenarioRunStartSolution);
    });
    ...
    it('should have the property solutionId (base name: "solutionId")', function() {
      ...
      //var instance = new CosmotechApi.ScenarioRunStartSolution();
