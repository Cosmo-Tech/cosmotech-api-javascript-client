...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CosmotechApi.ScenarioRunAllOf();
  });
  ...
  describe('ScenarioRunAllOf', function() {
    it('should create an instance of ScenarioRunAllOf', function() {
      // uncomment below and update the code to test ScenarioRunAllOf
      //var instane = new CosmotechApi.ScenarioRunAllOf();
      //expect(instance).to.be.a(CosmotechApi.ScenarioRunAllOf);
    });
    ...
    it('should have the property datasetList (base name: "datasetList")', function() {
      ...
      //var instance = new CosmotechApi.ScenarioRunAllOf();
