...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CosmotechApi.RunData();
  });
  ...
  describe('RunData', function() {
    it('should create an instance of RunData', function() {
      // uncomment below and update the code to test RunData
      //var instance = new CosmotechApi.RunData();
      //expect(instance).to.be.a(CosmotechApi.RunData);
    });
