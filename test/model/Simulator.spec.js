...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CosmotechApi.Simulator();
  });
  ...
  describe('Simulator', function() {
    it('should create an instance of Simulator', function() {
      ...
      //var instane = new CosmotechApi.Simulator();
      //expect(instance).to.be.a(CosmotechApi.Simulator);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CosmotechApi.Simulator();
