...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CosmotechApi.FileUploadValidation();
  });
  ...
  describe('FileUploadValidation', function() {
    it('should create an instance of FileUploadValidation', function() {
      // uncomment below and update the code to test FileUploadValidation
      //var instance = new CosmotechApi.FileUploadValidation();
      //expect(instance).to.be.a(CosmotechApi.FileUploadValidation);
    });
