...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CosmotechApi.RunStartContainers();
  });
  ...
  describe('RunStartContainers', function() {
    it('should create an instance of RunStartContainers', function() {
      // uncomment below and update the code to test RunStartContainers
      //var instance = new CosmotechApi.RunStartContainers();
      //expect(instance).to.be.a(CosmotechApi.RunStartContainers);
    });
