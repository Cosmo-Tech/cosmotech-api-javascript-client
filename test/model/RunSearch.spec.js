...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CosmotechApi.RunSearch();
  });
  ...
  describe('RunSearch', function() {
    it('should create an instance of RunSearch', function() {
      // uncomment below and update the code to test RunSearch
      //var instance = new CosmotechApi.RunSearch();
      //expect(instance).to.be.a(CosmotechApi.RunSearch);
    });
