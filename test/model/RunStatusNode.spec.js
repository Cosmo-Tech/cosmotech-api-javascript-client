...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CosmotechApi.RunStatusNode();
  });
  ...
  describe('RunStatusNode', function() {
    it('should create an instance of RunStatusNode', function() {
      // uncomment below and update the code to test RunStatusNode
      //var instance = new CosmotechApi.RunStatusNode();
      //expect(instance).to.be.a(CosmotechApi.RunStatusNode);
    });
    ...
    it('should have the property outboundNodes (base name: "outboundNodes")', function() {
      // uncomment below and update the code to test the property outboundNodes
      //var instance = new CosmotechApi.RunStatusNode();
      //expect(instance).to.be();
    });

    it('should have the property resourcesDuration (base name: "resourcesDuration")', function() {
      // uncomment below and update the code to test the property resourcesDuration
      //var instance = new CosmotechApi.RunStatusNode();
      //expect(instance).to.be();
    });
