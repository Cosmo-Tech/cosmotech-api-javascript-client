...
(function(root, factory) {
  ...
  describe('Workspace', function() {
    ...
    it('should have the property linkedDatasetIdList (base name: "linkedDatasetIdList")', function() {
      // uncomment below and update the code to test the property linkedDatasetIdList
      //var instance = new CosmotechApi.Workspace();
      //expect(instance).to.be();
    });
    ...
    it('should have the property datasetCopy (base name: "datasetCopy")', function() {
      // uncomment below and update the code to test the property datasetCopy
      //var instance = new CosmotechApi.Workspace();
      //expect(instance).to.be();
    });
