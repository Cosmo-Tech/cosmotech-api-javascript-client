...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CosmotechApi.ScenarioRunBase();
  });
  ...
  describe('ScenarioRunBase', function() {
    it('should create an instance of ScenarioRunBase', function() {
      // uncomment below and update the code to test ScenarioRunBase
      //var instane = new CosmotechApi.ScenarioRunBase();
      //expect(instance).to.be.a(CosmotechApi.ScenarioRunBase);
    });

    it('should have the property id (base name: "id")', function() {
      // uncomment below and update the code to test the property id
      //var instance = new CosmotechApi.ScenarioRunBase();
