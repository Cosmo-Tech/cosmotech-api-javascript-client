...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CosmotechApi.RunnerLastRun();
  });
  ...
  describe('RunnerLastRun', function() {
    it('should create an instance of RunnerLastRun', function() {
      // uncomment below and update the code to test RunnerLastRun
      //var instance = new CosmotechApi.RunnerLastRun();
      //expect(instance).to.be.a(CosmotechApi.RunnerLastRun);
    });
