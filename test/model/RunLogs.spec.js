...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CosmotechApi.RunLogs();
  });
  ...
  describe('RunLogs', function() {
    it('should create an instance of RunLogs', function() {
      // uncomment below and update the code to test RunLogs
      //var instance = new CosmotechApi.RunLogs();
      //expect(instance).to.be.a(CosmotechApi.RunLogs);
    });
