...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CosmotechApi.SimulationAllOf();
  });
  ...
  describe('SimulationAllOf', function() {
    it('should create an instance of SimulationAllOf', function() {
      // uncomment below and update the code to test SimulationAllOf
      //var instane = new CosmotechApi.SimulationAllOf();
      //expect(instance).to.be.a(CosmotechApi.SimulationAllOf);
    });
    ...
    it('should have the property datasetList (base name: "datasetList")', function() {
      ...
      //var instance = new CosmotechApi.SimulationAllOf();
