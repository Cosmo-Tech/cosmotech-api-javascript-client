...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CosmotechApi.WorkspaceWebApp();
  });
  ...
  describe('WorkspaceWebApp', function() {
    ...
    it('should have the property iframes (base name: "iframes")', function() {
      // uncomment below and update the code to test the property iframes
      //var instance = new CosmotechApi.WorkspaceWebApp();
      //expect(instance).to.be();
    });
