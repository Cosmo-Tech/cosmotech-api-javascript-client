...
(function(root, factory) {
  ...
  describe('ConnectorApi', function() {
    ...
    describe('uploadConnector', function() {
      it('should call uploadConnector successfully', function(done) {
        //uncomment below and update the code to test uploadConnector
        //instance.uploadConnector(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
