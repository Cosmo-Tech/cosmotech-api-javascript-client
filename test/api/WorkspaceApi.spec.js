...
(function(root, factory) {
  ...
  describe('WorkspaceApi', function() {
    ...
    describe('importWorkspace', function() {
      it('should call importWorkspace successfully', function(done) {
        //uncomment below and update the code to test importWorkspace
        //instance.importWorkspace(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
