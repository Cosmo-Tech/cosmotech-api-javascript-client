...
let organizationUser = [{"name":"Charles","id":"3","roles":["User"]},{"name":"Alice","id":"3","roles":["Developer"]}]; // [OrganizationUser] | the Users to add. Any User with the same ID is overwritten
