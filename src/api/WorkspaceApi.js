...
export default class WorkspaceApi {
    ...
    */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/WorkspaceSecurity} and HTTP response
     */
    setWorkspaceDefaultSecurityWithHttpInfo(organizationId, workspaceId, body) {
      let postBody = body;
      // verify the required parameter 'organizationId' is set
      if (organizationId === undefined || organizationId === null) {
      ...
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling setWorkspaceDefaultSecurity");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/WorkspaceSecurity}
     */
    setWorkspaceDefaultSecurity(organizationId, workspaceId, body) {
      return this.setWorkspaceDefaultSecurityWithHttpInfo(organizationId, workspaceId, body)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
