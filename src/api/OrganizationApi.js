...
export default class OrganizationApi {
    ...
    */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/OrganizationSecurity} and HTTP response
     */
    setOrganizationDefaultSecurityWithHttpInfo(organizationId, body) {
      let postBody = body;
      // verify the required parameter 'organizationId' is set
      if (organizationId === undefined || organizationId === null) {
      ...
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling setOrganizationDefaultSecurity");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/OrganizationSecurity}
     */
    setOrganizationDefaultSecurity(organizationId, body) {
      return this.setOrganizationDefaultSecurityWithHttpInfo(organizationId, body)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
