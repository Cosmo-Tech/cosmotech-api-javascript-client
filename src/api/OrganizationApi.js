...
export default class OrganizationApi {
    ...
    */
     ...
     * @param {module:model/Organization} organization the Organization to import
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/Organization} and HTTP response
     */
    importOrganizationWithHttpInfo(organization) {
      let postBody = organization;
      // verify the required parameter 'organization' is set
      if (organization === undefined || organization === null) {
        throw new Error("Missing the required parameter 'organization' when calling importOrganization");
      }
    ...
    importOrganization(organization) {
      return this.importOrganizationWithHttpInfo(organization)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
