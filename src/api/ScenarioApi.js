...
export default class ScenarioApi {
    ...
    */
     ...
     */
    getScenarioPermissionsWithHttpInfo(organizationId, workspaceId, scenarioId, role) {
      let postBody = null;
      // verify the required parameter 'organizationId' is set
      if (organizationId === undefined || organizationId === null) {
      ...
      // verify the required parameter 'scenarioId' is set
      if (scenarioId === undefined || scenarioId === null) {
        throw new Error("Missing the required parameter 'scenarioId' when calling getScenarioPermissions");
      }
      ...
      return this.apiClient.callApi(
        '/organizations/{organization_id}/workspaces/{workspace_id}/scenarios/{scenario_id}/permissions/{role}', 'GET',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     */
    getScenarioPermissions(organizationId, workspaceId, scenarioId, role) {
      return this.getScenarioPermissionsWithHttpInfo(organizationId, workspaceId, scenarioId, role)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {String} workspaceId the Workspace identifier
     * @param {String} scenarioId the Scenario identifier
     * @param {module:model/Scenario} scenario the new Scenario details. This endpoint can't be used to update security
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/Scenario} and HTTP response
     */
