...
export default class ScenarioApi {
    ...
    */
     ...
     */
    findAllScenariosWithHttpInfo(organizationId, workspaceId, opts) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'organizationId' is set
      if (organizationId === undefined || organizationId === null) {
     ...
     */
    findAllScenarios(organizationId, workspaceId, opts) {
      return this.findAllScenariosWithHttpInfo(organizationId, workspaceId, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Array.<module:model/Scenario>} and HTTP response
     */
    findAllScenariosByValidationStatusWithHttpInfo(organizationId, workspaceId, validationStatus, opts) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'organizationId' is set
      if (organizationId === undefined || organizationId === null) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Array.<module:model/Scenario>}
     */
    findAllScenariosByValidationStatus(organizationId, workspaceId, validationStatus, opts) {
      return this.findAllScenariosByValidationStatusWithHttpInfo(organizationId, workspaceId, validationStatus, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {String} organizationId the Organization identifier
     * @param {String} workspaceId the Workspace identifier
     * @param {module:model/Scenario} scenario the Scenario to import
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/Scenario} and HTTP response
     */
    importScenarioWithHttpInfo(organizationId, workspaceId, scenario) {
      let postBody = scenario;
      // verify the required parameter 'organizationId' is set
      if (organizationId === undefined || organizationId === null) {
        throw new Error("Missing the required parameter 'organizationId' when calling importScenario");
      }
      // verify the required parameter 'workspaceId' is set
      if (workspaceId === undefined || workspaceId === null) {
        throw new Error("Missing the required parameter 'workspaceId' when calling importScenario");
      }
      // verify the required parameter 'scenario' is set
      if (scenario === undefined || scenario === null) {
        throw new Error("Missing the required parameter 'scenario' when calling importScenario");
      }
      ...
      let returnType = Scenario;
      return this.apiClient.callApi(
        '/organizations/{organization_id}/workspaces/{workspace_id}/scenarios/import', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/Scenario}
     */
    importScenario(organizationId, workspaceId, scenario) {
      return this.importScenarioWithHttpInfo(organizationId, workspaceId, scenario)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    setScenarioDefaultSecurityWithHttpInfo(organizationId, workspaceId, scenarioId, scenarioRole) {
      ...
      if (scenarioRole === undefined || scenarioRole === null) {
        throw new Error("Missing the required parameter 'scenarioRole' when calling setScenarioDefaultSecurity");
      }
    ...
    setScenarioDefaultSecurity(organizationId, workspaceId, scenarioId, scenarioRole) {
      return this.setScenarioDefaultSecurityWithHttpInfo(organizationId, workspaceId, scenarioId, scenarioRole)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {String} scenarioId the Scenario identifier
     * @param {String} identityId the User identifier
     * @param {module:model/ScenarioRole} scenarioRole The new Scenario Access Control
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ScenarioAccessControl} and HTTP response
     */
    updateScenarioAccessControlWithHttpInfo(organizationId, workspaceId, scenarioId, identityId, scenarioRole) {
      let postBody = scenarioRole;
      // verify the required parameter 'organizationId' is set
      if (organizationId === undefined || organizationId === null) {
        throw new Error("Missing the required parameter 'organizationId' when calling updateScenarioAccessControl");
      }
      // verify the required parameter 'workspaceId' is set
      if (workspaceId === undefined || workspaceId === null) {
        throw new Error("Missing the required parameter 'workspaceId' when calling updateScenarioAccessControl");
      }
      // verify the required parameter 'scenarioId' is set
      if (scenarioId === undefined || scenarioId === null) {
        throw new Error("Missing the required parameter 'scenarioId' when calling updateScenarioAccessControl");
      }
      // verify the required parameter 'identityId' is set
      if (identityId === undefined || identityId === null) {
        throw new Error("Missing the required parameter 'identityId' when calling updateScenarioAccessControl");
      }
      // verify the required parameter 'scenarioRole' is set
      if (scenarioRole === undefined || scenarioRole === null) {
        throw new Error("Missing the required parameter 'scenarioRole' when calling updateScenarioAccessControl");
      }
      ...
      let returnType = ScenarioAccessControl;
      return this.apiClient.callApi(
        '/organizations/{organization_id}/workspaces/{workspace_id}/scenarios/{scenario_id}/security/access/{identity_id}', 'PATCH',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ScenarioAccessControl}
     */
    updateScenarioAccessControl(organizationId, workspaceId, scenarioId, identityId, scenarioRole) {
      return this.updateScenarioAccessControlWithHttpInfo(organizationId, workspaceId, scenarioId, identityId, scenarioRole)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
