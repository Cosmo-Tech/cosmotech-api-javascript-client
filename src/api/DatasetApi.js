...
export default class DatasetApi {
    ...
    */
     ...
     * @param {String} organizationId the Organization identifier
     * @param {module:model/Dataset} dataset the Dataset to import
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/Dataset} and HTTP response
     */
    importDatasetWithHttpInfo(organizationId, dataset) {
      let postBody = dataset;
      // verify the required parameter 'organizationId' is set
      if (organizationId === undefined || organizationId === null) {
        throw new Error("Missing the required parameter 'organizationId' when calling importDataset");
      }
      // verify the required parameter 'dataset' is set
      if (dataset === undefined || dataset === null) {
        throw new Error("Missing the required parameter 'dataset' when calling importDataset");
      }
      ...
      let returnType = Dataset;
      return this.apiClient.callApi(
        '/organizations/{organization_id}/datasets/import', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/Dataset}
     */
    importDataset(organizationId, dataset) {
      return this.importDatasetWithHttpInfo(organizationId, dataset)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
