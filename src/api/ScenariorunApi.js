...
export default class ScenariorunApi {
    ...
    */
     ...
     */
    getScenarioRunsWithHttpInfo(organizationId, workspaceId, scenarioId, opts) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'organizationId' is set
      if (organizationId === undefined || organizationId === null) {
     ...
     */
    getScenarioRuns(organizationId, workspaceId, scenarioId, opts) {
      return this.getScenarioRunsWithHttpInfo(organizationId, workspaceId, scenarioId, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Array.<module:model/ScenarioRun>} and HTTP response
     */
    getWorkspaceScenarioRunsWithHttpInfo(organizationId, workspaceId, opts) {
      opts = opts || {};
      let postBody = null;
      // verify the required parameter 'organizationId' is set
      if (organizationId === undefined || organizationId === null) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Array.<module:model/ScenarioRun>}
     */
    getWorkspaceScenarioRuns(organizationId, workspaceId, opts) {
      return this.getWorkspaceScenarioRunsWithHttpInfo(organizationId, workspaceId, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @param {String} workspaceId the Workspace identifier
     * @param {String} scenarioId the Scenario identifier
     * @param {module:model/ScenarioRun} scenarioRun the ScenarioRun to import
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ScenarioRun} and HTTP response
     */
    importScenarioRunWithHttpInfo(organizationId, workspaceId, scenarioId, scenarioRun) {
      let postBody = scenarioRun;
      // verify the required parameter 'organizationId' is set
      if (organizationId === undefined || organizationId === null) {
        throw new Error("Missing the required parameter 'organizationId' when calling importScenarioRun");
      }
      // verify the required parameter 'workspaceId' is set
      if (workspaceId === undefined || workspaceId === null) {
        throw new Error("Missing the required parameter 'workspaceId' when calling importScenarioRun");
      }
      // verify the required parameter 'scenarioId' is set
      if (scenarioId === undefined || scenarioId === null) {
        throw new Error("Missing the required parameter 'scenarioId' when calling importScenarioRun");
      }
      // verify the required parameter 'scenarioRun' is set
      if (scenarioRun === undefined || scenarioRun === null) {
        throw new Error("Missing the required parameter 'scenarioRun' when calling importScenarioRun");
      }
      ...
      let returnType = ScenarioRun;
      return this.apiClient.callApi(
        '/organizations/{organization_id}/workspaces/{workspace_id}/scenarios/{scenario_id}/run/import', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, null
      );
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/ScenarioRun}
     */
    importScenarioRun(organizationId, workspaceId, scenarioId, scenarioRun) {
      return this.importScenarioRunWithHttpInfo(organizationId, workspaceId, scenarioId, scenarioRun)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Array.<module:model/ScenarioRun>} and HTTP response
     */
    searchScenarioRunsWithHttpInfo(organizationId, scenarioRunSearch, opts) {
      opts = opts || {};
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Array.<module:model/ScenarioRun>}
     */
    searchScenarioRuns(organizationId, scenarioRunSearch, opts) {
      return this.searchScenarioRunsWithHttpInfo(organizationId, scenarioRunSearch, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
