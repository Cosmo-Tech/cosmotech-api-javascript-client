...
/**
* Enum class RunSearchState.
* @enum {}
* @readonly
*/
export default class RunSearchState {
    ...
    /**
    * Returns a <code>RunSearchState</code> enum value from a Javascript object name.
    * @param {Object} data The plain JavaScript object containing the name of the enum value.
    * @return {module:model/RunSearchState} The enum <code>RunSearchState</code> value.
    */
