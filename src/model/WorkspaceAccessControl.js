...
class WorkspaceAccessControl {
    ...
    /**
     * Validates the JSON data with respect to <code>WorkspaceAccessControl</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WorkspaceAccessControl</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WorkspaceAccessControl.RequiredProperties) {
...
WorkspaceAccessControl.RequiredProperties = ["id", "role"];
