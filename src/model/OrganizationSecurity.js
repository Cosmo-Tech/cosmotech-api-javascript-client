...
import RbacAccessControl from './RbacAccessControl';
...
class OrganizationSecurity {
     ...
     * @param accessControlList {Array.<module:model/RbacAccessControl>} the list which can access this Organization with detailed access control information
     */
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('accessControlList')) {
                obj['accessControlList'] = ApiClient.convertToType(data['accessControlList'], [RbacAccessControl]);
            }
        }
        return obj;
    }
 ...
 * @member {Array.<module:model/RbacAccessControl>} accessControlList
 */
