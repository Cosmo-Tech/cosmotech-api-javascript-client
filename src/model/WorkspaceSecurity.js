...
class WorkspaceSecurity {
    ...
    /**
     * Validates the JSON data with respect to <code>WorkspaceSecurity</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WorkspaceSecurity</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of WorkspaceSecurity.RequiredProperties) {
        ...
        if (data['accessControlList']) { // data not null
            ...
            for (const item of data['accessControlList']) {
                WorkspaceAccessControl.validateJSON(item);
            };
        }
...
WorkspaceSecurity.RequiredProperties = ["default", "accessControlList"];
