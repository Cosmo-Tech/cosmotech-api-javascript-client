...
class ScenarioSecurity {
    ...
    /**
     * Validates the JSON data with respect to <code>ScenarioSecurity</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ScenarioSecurity</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ScenarioSecurity.RequiredProperties) {
        ...
        if (data['accessControlList']) { // data not null
            ...
            for (const item of data['accessControlList']) {
                ScenarioAccessControl.validateJSON(item);
            };
        }
...
ScenarioSecurity.RequiredProperties = ["default", "accessControlList"];
