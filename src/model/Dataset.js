...
class Dataset {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('ingestionStatus')) {
                obj['ingestionStatus'] = ApiClient.convertToType(data['ingestionStatus'], 'String');
            }
            if (data.hasOwnProperty('twincacheStatus')) {
                obj['twincacheStatus'] = ApiClient.convertToType(data['twincacheStatus'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['ingestionStatus'] && !(typeof data['ingestionStatus'] === 'string' || data['ingestionStatus'] instanceof String)) {
            throw new Error("Expected the field `ingestionStatus` to be a primitive type in the JSON string but got " + data['ingestionStatus']);
        }
        // ensure the json data is a string
        if (data['twincacheStatus'] && !(typeof data['twincacheStatus'] === 'string' || data['twincacheStatus'] instanceof String)) {
            throw new Error("Expected the field `twincacheStatus` to be a primitive type in the JSON string but got " + data['twincacheStatus']);
        }
        // ensure the json data is an array
 ...
 * @member {module:model/Dataset.IngestionStatusEnum} ingestionStatus
 */
Dataset.prototype['ingestionStatus'] = undefined;

/**
 * the twincache data status
 * @member {module:model/Dataset.TwincacheStatusEnum} twincacheStatus
 */
...
/**
 * Allowed values for the <code>ingestionStatus</code> property.
 * @enum {String}
 * @readonly
 */
Dataset['IngestionStatusEnum'] = {
...
/**
 * Allowed values for the <code>twincacheStatus</code> property.
 * @enum {String}
 * @readonly
 */
Dataset['TwincacheStatusEnum'] = {
