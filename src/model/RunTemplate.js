...
class RunTemplate {
    ...
    /**
     * Validates the JSON data with respect to <code>RunTemplate</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RunTemplate</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of RunTemplate.RequiredProperties) {
        ...
        // ensure the json data is a string
        if (data['csmSimulation'] && !(typeof data['csmSimulation'] === 'string' || data['csmSimulation'] instanceof String)) {
            throw new Error("Expected the field `csmSimulation` to be a primitive type in the JSON string but got " + data['csmSimulation']);
        }
        ...
        if (data['runSizing']) { // data not null
          RunTemplateResourceSizing.validateJSON(data['runSizing']);
        }
        // ensure the json data is an array
        ...
        // ensure the json data is a string
        if (data['gitRepositoryUrl'] && !(typeof data['gitRepositoryUrl'] === 'string' || data['gitRepositoryUrl'] instanceof String)) {
            throw new Error("Expected the field `gitRepositoryUrl` to be a primitive type in the JSON string but got " + data['gitRepositoryUrl']);
        }
        // ensure the json data is a string
        if (data['gitBranchName'] && !(typeof data['gitBranchName'] === 'string' || data['gitBranchName'] instanceof String)) {
            throw new Error("Expected the field `gitBranchName` to be a primitive type in the JSON string but got " + data['gitBranchName']);
        }
        // ensure the json data is a string
        if (data['runTemplateSourceDir'] && !(typeof data['runTemplateSourceDir'] === 'string' || data['runTemplateSourceDir'] instanceof String)) {
            throw new Error("Expected the field `runTemplateSourceDir` to be a primitive type in the JSON string but got " + data['runTemplateSourceDir']);
        }
        // validate the optional field `deleteHistoricalData`
        if (data['deleteHistoricalData']) { // data not null
          DeleteHistoricalData.validateJSON(data['deleteHistoricalData']);
        }
...
RunTemplate.RequiredProperties = ["id"];
 ...
 */
RunTemplate.prototype['labels'] = undefined;
