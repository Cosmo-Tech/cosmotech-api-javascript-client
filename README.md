...
- Package version: 3.2.1-SNAPSHOT
...
*CosmotechApi.DatasetApi* | [**linkWorkspace**](docs/DatasetApi.md#linkWorkspace) | **POST** /organizations/{organization_id}/datasets/{dataset_id}/link | 
...
*CosmotechApi.RunnerApi* | [**startRun**](docs/RunnerApi.md#startRun) | **POST** /organizations/{organization_id}/workspaces/{workspace_id}/runners/{runner_id}/start | Start a run with runner parameters
...
## Documentation for Models
 ...
 - [CosmotechApi.IngestionStatusEnum](docs/IngestionStatusEnum.md)
 - [CosmotechApi.IoTypesEnum](docs/IoTypesEnum.md)
 ...
 - [CosmotechApi.RunSearchState](docs/RunSearchState.md)
 ...
 - [CosmotechApi.ScenarioRunSearchState](docs/ScenarioRunSearchState.md)
 ...
 - [CosmotechApi.TwincacheStatusEnum](docs/TwincacheStatusEnum.md)
